...
if nav == 'Recommender':
  ...
  st.markdown('--------------------------------------------------')
  st.subheader('Developed by Anshika')
  ...
  st.subheader('About')
  st.markdown('----------------------------------')
  st.markdown('#### Hello friends, I am Anshika 🌸.  Are you an avid reader like me and you need some really good recommendations about books? You have come to right place. At Recommended Reader, we will handpick the best books for you that you will definitely enjoy reading!')
